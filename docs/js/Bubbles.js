...
function Bubbles(container, self, options) {
  ...
  widerBy = options.widerBy || 35 // add a little extra width to bubbles to make sure they don't break
  sidePadding = options.sidePadding || 8 // padding on both sides of chat bubbles
